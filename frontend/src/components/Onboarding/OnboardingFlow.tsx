        ...
        {step === 1 && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4">
            <div className="text-center">
              <h1 className="text-4xl sm:text-5xl font-black italic uppercase tracking-tighter text-black mb-2">BHUBEZI</h1>
              <p className="text-sm font-black text-black/60 uppercase tracking-widest">SA's #1 Taxi Network</p>
            </div>
